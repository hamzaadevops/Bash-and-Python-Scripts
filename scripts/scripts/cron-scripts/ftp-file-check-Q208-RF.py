...
def main():
    ...
    response: object = snsClient.publish(TopicArn=topicArn,
                                         Message='Dear Team, please check Q208 RV_VOLT location, today\'s file is not recieved',
                                         Subject='Alert: FTP Server Q208 File Check'
                                         )
...
check_file_exist('/etc/ftp-dir/Q208/RV_VOLT/')
