...
def main():
    ...
    response: object = snsClient.publish(TopicArn=topicArn,
                                         Message='Dear Team, please check HWPP RF_VOLT location, today\'s file is not recieved',
                                         Subject='Alert: FTP Server HWPP File Check'
                                         )
...
check_file_exist('/etc/ftp-dir/HWPP/RF_VOLT/')
