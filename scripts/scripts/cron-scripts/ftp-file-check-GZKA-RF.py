...
def main():
    ...
    response: object = snsClient.publish(TopicArn=topicArn,
                                         Message='Dear Team, please check GZKA RF_VOLT location, today\'s file is not recieved',
                                         Subject='Alert: FTP Server GZKA File Check'
                                         )
...
check_file_exist('/etc/ftp-dir/GZKA/RF_VOLT/')
