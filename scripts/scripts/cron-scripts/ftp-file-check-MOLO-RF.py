...
def main():
    ...
    response: object = snsClient.publish(TopicArn=topicArn,
                                         Message='Dear Team, please check MOLO RF_VOLT location, today\'s file is not recieved',
                                         Subject='Alert: FTP Server MOLO File Check'
                                         )
...
check_file_exist('/etc/ftp-dir/MOLO/RF_VOLT/')
