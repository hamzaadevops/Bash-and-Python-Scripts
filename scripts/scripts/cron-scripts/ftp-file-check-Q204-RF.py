...
def main():
    ...
    response: object = snsClient.publish(TopicArn=topicArn,
                                         Message='Dear Team, please check Q204 RF_VOLT location, today\'s file is not recieved',
                                         Subject='Alert: FTP Server Q204 File Check'
                                         )
...
check_file_exist('/etc/ftp-dir/Q204/RF_VOLT/')
